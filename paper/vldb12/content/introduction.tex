...
\system supports a declarative query interface and \jag{REMOVE
**}real-time \jag{** REMOVE} query processing that is needed for ad hoc
...
\begin{itemize}
\item \jag{REMOVE **}Real-time\jag{** REMOVE} processing of ad hoc queries 
