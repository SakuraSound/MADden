...
and political campaign management---to show (1) \jag{REMOVE
**}real-time\jag{** REMOVE} processing of ad hoc queries involving statistical
text analysis; (2) joining between structured and textual data; and (3) query-time rendering of
