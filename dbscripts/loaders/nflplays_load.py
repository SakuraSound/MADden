...
__pwd = ''
__user = ''
__table = 'nflplays' # REQUIRED: Not included in the db.json file
...
def __querya():
	...
	(playnum, gamedate, team1, team2, fileloc, play) \
	VALUES """ % {'table': __table}

def __queryb():
	return """ (%(playnum)s, %(gamedate)s, %(team1)s, %(team2)s, %(fileloc)s, %(play)s) """ 
...
if __name__ == '__main__':
	if len(sys.argv) <= 1 or not os.path.exists(sys.argv[1]):
		print "Usage: python nflplay_load.py ~/scratch/gamepbps"
